...
Clusters were split on a number of features such as sex, family relationship type, marital status, age, and earnings. KPrototypes clusters were much more imbalanced than those produced by KModes. This is most likely due to the extra dimensionality created by clustering on both numerical and categorical data.
